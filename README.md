...
说明 & 解决: 捕获catch throw的error. 非常类似前面两个case的, 对rejectHandler try-catch就好.
...
### case 16: second argument in then is treated as a rejection handler.
...
说明: then支持接受第二个参数, 作为rejectionHandler.   

解决: 让then接收第二个参数为rejectionHandler, 在存在的情况下push进queue就好.
